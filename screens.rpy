            ...
            frame:
                ...
                vbox:
                    ...
                    for i, c in enumerate(gathered_clues):
                        $ _num = i + 1
                        text "[_num]. [c]" style "game_panel_text" size 16 color "#ffffff" xmaximum 816
            null height 15
            hbox:
                spacing 20
        ...
        vbox:
            ...
            frame:
                ...
                viewport:
                    ...
                    vbox:
                        xsize 636
                        text "[store.how_to_play_content]" size 18 text_align 0.0 color "#ffffff" xmaximum 636
            null height 10
            ...
            grid 3 3:
                ...
                for evo in store.EEVEELUTIONS:
                    vbox:
                        ...
                        textbutton evo action Return(evo) style "game_action_button" xminimum 140
                null
            null height 12
            ...
            grid 3 3:
                ...
                for loc in store.LOCATIONS:
                    ...
                    vbox:
                        ...
                        textbutton loc action Return(loc) style "game_action_button" xminimum 140
                null
            null height 12
            textbutton "Back" action Return(None) style "game_back_button" xalign 0.5
        ...
        vbox:
            ...
            frame:
                ...
                vbox:
                    ...
                    for i, c in enumerate(gathered_clues):
                        $ _num = i + 1
                        text "[_num]. [c]" style "game_panel_text" size 18 color "#ffffff" xmaximum 536
            null height 10
